const translations = {
    ...
    tr: {
        ...
        settings: {
            ...
            firebaseTitle: "Canlı Veritabanı",
            firebaseConnected: "Firebase Bağlandı",
            firebaseNotConnected: "Firebase Bağlı Değil",
            firebaseSyncing: "Eşitleniyor...",
            firebaseAnon: "Anonim kullanıcı aktif",
            firebaseLive: "Canlı senkronizasyon aktif",
            firebaseConnecting: "Firebase'e bağlanılıyor...",
    ...
    ar: {
        ...
        settings: {
            ...
            firebaseTitle: "قاعدة البيانات المباشرة",
            firebaseConnected: "Firebase متصل",
            firebaseNotConnected: "Firebase غير متصل",
            firebaseSyncing: "جاري المزامنة...",
            firebaseAnon: "المستخدم المجهول نشط",
            firebaseLive: "المزامنة المباشرة نشطة",
